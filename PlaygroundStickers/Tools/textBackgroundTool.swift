...
protocol textBackgroundToolDelegate {
    func textBackgroundToolsTapped(Index: Int)
    
}

class textBackgroundTool: UIView {
    
    var collectionView: UICollectionView!
    var Delegate : textBackgroundToolDelegate?
    ...
    fileprivate var currentPage: Int = 0 {
        didSet {
            self.Delegate?.textBackgroundToolsTapped(Index: currentPage)
        }
    }
    ...
    var Array = ["Off","color2","angular","opacity"]
    ...
    private func setupView() {
        ...
        collectionView.register(textBackgroundToolCell.self, forCellWithReuseIdentifier: "textBackgroundToolCell")
...
extension textBackgroundTool: UICollectionViewDataSource {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        guard let cell = collectionView.dequeueReusableCell(withReuseIdentifier: "textBackgroundToolCell", for: indexPath) as? textBackgroundToolCell
...
extension textBackgroundTool: UICollectionViewDelegate {
...
class textBackgroundToolCell: UICollectionViewCell {
