...
class imageTools: UIView {
    
    var collectionView: UICollectionView!
    var Delegate : imageToolDelegate?
    
    var bottomToolsArray = ["filter","mask","shadow","opacity","rotate","size","size2"]
    ...
    private func setupView() {
        ...
        collectionView.register(imageToolCell.self, forCellWithReuseIdentifier: "imageToolCell")
...
extension imageTools: UICollectionViewDataSource {
    func collectionView(_ collectionView: UICollectionView, numberOfItemsInSection section: Int) -> Int {
        return bottomToolsArray.count
    }
    
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        guard let cell = collectionView.dequeueReusableCell(withReuseIdentifier: "imageToolCell", for: indexPath) as? imageToolCell
...
extension imageTools: UICollectionViewDelegate {
    func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        
        collectionView.scrollToItem(at: indexPath, at: .centeredHorizontally, animated: true)
        self.Delegate?.imageToolTapped(index: indexPath.row)
...
class imageToolCell: UICollectionViewCell {
    let img: UIImageView = {
