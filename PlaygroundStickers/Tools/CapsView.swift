...
protocol CapsViewDelegate {
    func CapsViewTapped(index: Int)
}

class CapsView: UIView {
    
    var collectionView: UICollectionView!
    var Delegate : CapsViewDelegate?
    
    var Array = ["capitalized","uppercased","lowercased"]
    ...
    fileprivate var currentPage: Int = 0 {
        didSet {
            self.Delegate?.CapsViewTapped(index: currentPage)
    ...
    private func setupView() {
        ...
        collectionView.register(CapsViewCell.self, forCellWithReuseIdentifier: "CapsViewCell")
...
extension CapsView: UICollectionViewDataSource {
    func collectionView(_ collectionView: UICollectionView, numberOfItemsInSection section: Int) -> Int {
        return Array.count
    }
    
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        guard let cell = collectionView.dequeueReusableCell(withReuseIdentifier: "CapsViewCell", for: indexPath) as? CapsViewCell
...
extension CapsView: UICollectionViewDelegate {
...
class CapsViewCell: UICollectionViewCell {
    let img: UIImageView = {
