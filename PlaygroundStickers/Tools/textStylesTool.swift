...
protocol textStylesToolDelegate {
    func textStylesToolTapped(Index: Int)
    
}

class textStylesTool: UIView {
    
    var collectionView: UICollectionView!
    var Delegate : textStylesToolDelegate?
    ...
    fileprivate var currentPage: Int = 0 {
        didSet {
            self.Delegate?.textStylesToolTapped(Index: currentPage)
        }
    }
    ...
    private func setupView() {
        ...
        collectionView.register(textStylesToolCell.self, forCellWithReuseIdentifier: "textStylesToolCell")
...
extension textStylesTool: UICollectionViewDataSource {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        guard let cell = collectionView.dequeueReusableCell(withReuseIdentifier: "textStylesToolCell", for: indexPath) as? textStylesToolCell
...
extension textStylesTool: UICollectionViewDelegate {
...
class textStylesToolCell: UICollectionViewCell {
